...
//////////////////////////////
const int arac_sayisi=200;



int  yol1[35][2]={0};//baðlar cad.
int  yol2[71][2]={0};//sahil yolu(tamamý)
int  yol3[20][2]={0};//sahil yolu--->Tekirdað-Ýstanbul yolu
int  yol4[29][2]={0};
int  yol5[45][2]={0};
int yol52[15][2]={0};
int  yol6[26][2]={0};
...
int yol16[10][2]={0};
/////////////
int kol1[6]={0};//çapraz yol(sol üst)-->yön 7
int kol2[6]={0};//çapraz yol(sað üst)-->yön 8
int kol3[6]={0};//çapraz yol(sol alt)-->yön 6
int kol4[6]={0};//çapraz yol(sað alt)-->yön 5

int kol2_1[5]={0};//çapraz yol(sol üst)-->yön 7
int kol2_2[5]={0};//çapraz yol(sað üst)-->yön 8
int kol2_3[5]={0};//çapraz yol(sol alt)-->yön 6
int kol2_4[5]={0};//çapraz yol(sað alt)-->yön 5
...
float arac_dizisi[arac_sayisi][8]={//solX,solY,arc_tip,hýz,yon,yol_id,serit_id,hc_id
	...
	{70*3.75,4*3.75,0,1,1,2,0,36},//otomobil	
	{78*3.75,4*3.75,0,1,1,2,0,40},//otomobil	
	{86*3.75,4*3.75,4,1,1,2,0,44},//kamyonet
	...
	{10*3.75,6*3.75,2,1,2,2,1,5},//kamyon
	{14*3.75,6*3.75,4,1,2,2,1,7},//kamyonet
	{20*3.75,6*3.75,0,1,2,2,1,10},//otomobil
	{26*3.75,6*3.75,4,1,2,2,1,13},//kamyonet
	{36*3.75,6*3.75,4,1,2,2,1,18},//kamyonet
	{44*3.75,6*3.75,0,1,2,2,1,22},//otomobil	
	{58*3.75,6*3.75,4,1,2,2,1,29},//kamyonet
	{82*3.75,6*3.75,4,1,2,2,1,41},//kamyonet
	{106*3.75,6*3.75,4,1,2,2,1,53},//kamyonet
	{112*3.75,6*3.75,0,1,2,2,1,56},//otomobil
	{122*3.75,6*3.75,0,1,2,2,1,61},//otomobil	
	{128*3.75,6*3.75,0,1,2,2,1,64},//otomobil	
	{132*3.75,6*3.75,2,1,2,2,1,66},//kamyon
	...
	{36*3.75,36*3.75,2,1,4,3,1,15},//kamyon
...
////YOL10---------------------------------------->32 tane
	...
	{138*3.75,34*3.75,0,1,4,10,1,14},
	{138*3.75,38*3.75,0,1,4,10,1,16},
	{138*3.75,42*3.75,0,1,4,10,1,18},
	{138*3.75,46*3.75,0,1,4,10,1,20},
	{138*3.75,50*3.75,0,1,4,10,1,22},
	{138*3.75,54*3.75,0,1,4,10,1,24},
	{138*3.75,58*3.75,0,1,4,10,1,26},
	{138*3.75,64*3.75,0,1,4,10,1,29},
	{138*3.75,68*3.75,0,1,4,10,1,31},
	{138*3.75,74*3.75,0,1,4,10,1,34},
	{138*3.75,76*3.75,0,1,4,10,1,35},
	{138*3.75,80*3.75,0,1,4,10,1,37},
